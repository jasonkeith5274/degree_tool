...
def audit(request):
    ...
    # Determine what track the student is in
    if track == 70:
        track = "trad"
    ...
    # Need to determine what the requirements are for every possible track
    if track == "trad":
    ...
    # Save all of the elective courses the student has taken
    ...
    # Save all of the core courses that the student has taken
    ...
    # Save the core courses the student has yet to take
    ...
    # Save the leveling courses that the student has taken
    ...
    # If there are more core classes to take, then determine how many and the GPA required for the student
    ...
    # If there are more elective classes to take, then determine how many and the GPA requirement for the student
    ...
    # Now we need to create our lines that will be printed to the file
    title = 'Audit Report'
    text_lines = [
        'Name: ' + name,
        'Plan: Master',
